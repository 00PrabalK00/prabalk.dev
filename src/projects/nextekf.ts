  ...
  flows: [
    {
      ...
      steps: [
        {
          label: "Log the IMU at rest",
          detail: "Long enough for the Allan deviation curve to be meaningful.",
        },
        {
          label: "Allan variance analysis",
          detail: "Reads bias instability and random walk off the curve.",
        },
        {
          label: "Inject the measured terms as covariances",
          detail:
            "Into the IMU messages, so the consumer does not have to be told separately.",
        },
        {
          label: "EKF fuses encoders and IMU",
          detail: "Weighting each by quantified uncertainty.",
        },
