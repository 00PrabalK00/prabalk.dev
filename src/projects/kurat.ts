...
export const kurat: Project = {
  ...
  flows: [
    {
      ...
      steps: [
        ...
        {
          label: "Cognition",
          detail: "Whisper speech recognition and the conversation system.",
          tone: "decision",
          branches: [
        ...
        {
          label: "Action",
          detail: "Nav2 navigation on the mechanical platform.",
          tone: "decision",
          branches: [
            {
              label:
  ...
  gallery: [
    ...
    },
    {
      ...
      type: "image",
      caption: "Live detection running on the robot",
    },
  ],
