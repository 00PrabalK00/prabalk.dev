      ...
      steps: [
        {
          ...
          detail: "Terrain-aware planning over the asset.",
        },
        {
          label: "Fly it",
          detail: "MAVLink, validated against SITL before anything real.",
        },
        {
          label: "Reconstruct",
          detail:
          ...
          branches: [
            {
              label: "Reconstruction did not converge, stop, and say so",
              tone: "bad",
            },
        ...
        },
        {
          ...
          branches: [
            {
              label: "Gaps in the survey, declared, not silently averaged over",
              tone: "bad",
            },
  ...
  tables: [
    {
      ...
      rows: [
        ...
        [
          ...
          "Evaluated, confusion matrix published, including the classes it misses",
        ],
        ["Corrosion severity segmentation", "Evaluated"],
        ["Semantic land cover", "Experimental"],
        [
          "Rejected models",
          "Kept on record with their failure modes, dataset limitations and holdout design issues",
        ],
      ],
    },
  ],
