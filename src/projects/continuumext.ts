...
export const continuumext: Project = {
  ...
  flows: [
    {
      ...
      steps: [
        ...
        {
          label: "Is this site allowed, and is the tab private?",
          tone: "decision",
          branches: [
            {
              label: "Private tab, or site not permitted, capture refused",
              tone: "bad",
            },
  ...
  attribution: [
    {
      kind: "built-by-me",
      detail: "The extension and the native-messaging host.",
    },
  ],
